...
|  [`vite/no-import-meta-env-in-config`](./docs/rules/no-import-meta-env-in-config.md)           |  —  | [🟡](./docs/rules/presets/recommended.md) [🔴](./docs/rules/presets/strict.md) [🟣](./docs/rules/presets/all.md) [⚙️](./docs/rules/presets/configs.md) [🧪](./docs/rules/presets/vitest.md)       |
