...
> **Oxlint:** Compatible with Oxlint 1.80.0 across all 72 rules and eight presets; the [JavaScript plugin API remains alpha](https://oxc.rs/docs/guide/usage/linter/js-plugins.html), so the release gate reruns ESLint/Oxlint conformance coverage.
