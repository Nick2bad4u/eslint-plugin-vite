...
const fixturePath = path.join(temporaryRoot, "vite.config.ts");
...
const main = async () => {
    assert.equal(ruleNames.length, 72);
    assert.equal(configNames.length, 8);
